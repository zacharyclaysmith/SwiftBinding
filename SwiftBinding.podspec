#
#  Be sure to run `pod spec lint SwiftBinding.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "zacharyclaysmith" => "email@address.com" }
  # Or just: s.author    = "zacharyclaysmith"
  # s.authors            = { "zacharyclaysmith" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/zacharyclaysmith"
